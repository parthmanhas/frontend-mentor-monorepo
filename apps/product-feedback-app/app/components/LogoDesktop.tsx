export default function LogoDesktop({ className }: { className: string }) {

    // p-5 on container does not work, width of equal containers changes
    return <div className={` ${className} rounded-xl inline-flex flex-col justify-end relative overflow-hidden h-[150px]`}>
        ...
        <h2 className="pl-6 z-20">Frontend Mentor</h2>
